...
import com.studentservice.studentservice.entity.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handlingStudentNotFound(StudentNotFoundException exception, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handlingMethodArgumentNotValidException(MethodArgumentNotValidException exception, HttpServletRequest request) {
        ...
        exception.getBindingResult().getAllErrors().forEach((error) -> {
            ...
            String fieldtMessage = fieldError.getDefaultMessage();

            validationError.put(fieldName, fieldtMessage);
        });
